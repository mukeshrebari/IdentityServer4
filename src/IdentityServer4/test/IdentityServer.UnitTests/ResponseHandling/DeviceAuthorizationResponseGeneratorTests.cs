...
namespace IdentityServer.UnitTests.ResponseHandling
{
    public class DeviceAuthorizationResponseGeneratorTests
    {
        ...
        [Fact]
        public async Task ProcessAsync_when_valiationresult_null_exect_exceptionAsync()
        {
        ...
        [Fact]
        public async Task ProcessAsync_when_valiationresult_client_null_exect_exceptionAsync()
        {
        ...
        [Fact]
        public async Task ProcessAsync_when_baseurl_null_exect_exceptionAsync()
        {
